###########################################################################
## Makefile generated for Simulink model 'MotorControl'. 
## 
## Makefile     : MotorControl.mk
## Generated on : Fri Aug 26 11:28:53 2022
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MotorControl.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = E:/04_BLDC/BLDC_driver
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = MotorControl_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = MotorControl_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MotorControl.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/MotorControl_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=MotorControl -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/MotorControl_ert_rtw/HallExtiTask.c $(START_DIR)/MotorControl_ert_rtw/MotorControl.c $(START_DIR)/MotorControl_ert_rtw/MotorControl_data.c $(START_DIR)/MotorControl_ert_rtw/SystickTask.c
...
OBJS = HallExtiTask.obj MotorControl.obj MotorControl_data.obj SystickTask.obj
...
%.obj : $(START_DIR)/MotorControl_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
